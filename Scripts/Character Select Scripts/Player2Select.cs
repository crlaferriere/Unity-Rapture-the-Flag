...
public class Player2Select : MonoBehaviour {
    ...
    public Text Player2Text, Player2Character;
    ...
    private void ProcessInput()
    {
        ...
        if (selected)
        {
            if (curCharacter == 1 && !masterReference.Urial && !masterReference.P1Urial && !masterReference.P2Urial && !masterReference.P3Urial && !masterReference.P4Urial)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P2Urial = true;
                Player2Panel.GetComponent<Image>().color = Blue;
            ...
            else if (curCharacter == 2 && !masterReference.Barachial && !masterReference.P1Barachial && !masterReference.P2Barachial && !masterReference.P3Barachial && !masterReference.P4Barachial)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P2Barachial = true;
                Player2Panel.GetComponent<Image>().color = Blue;
                Player2Text.text = "Ready!";
            }
            else if (curCharacter == 3 && !masterReference.Lilith && !masterReference.P1Lilith && !masterReference.P2Lilith && !masterReference.P3Lilith && !masterReference.P4Lilith)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P2Lilith = true;
                Player2Panel.GetComponent<Image>().color = Red;
            ...
            else if (curCharacter == 4 && !masterReference.Azazel && !masterReference.P1Azazel && !masterReference.P2Azazel && !masterReference.P3Azazel && !masterReference.P4Azazel)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P2Azazel = true;
                Player2Panel.GetComponent<Image>().color = Red;
                AzazelVO.GetComponent<AudioSource>().Play();
                Player2Text.text = "Ready!";
            }
            else if (!MasterSelector.GetComponent<MasterSelector>().P2Urial && !MasterSelector.GetComponent<MasterSelector>().P2Barachial && !MasterSelector.GetComponent<MasterSelector>().P2Lilith && !MasterSelector.GetComponent<MasterSelector>().P2Azazel)
            {
                selected = false;
                deselected = true;
                canSwap = true;
        ...
        if (deselected)
        {
            ...
            if (curCharacter == 1)
            {
                MasterSelector.GetComponent<MasterSelector>().P2Urial = false;
                MasterSelector.GetComponent<MasterSelector>().Urial = false;
            }
            if (curCharacter == 2)
            {
                MasterSelector.GetComponent<MasterSelector>().P2Barachial = false;
                MasterSelector.GetComponent<MasterSelector>().Barachial = false;
            }
            if (curCharacter == 3)
            {
                MasterSelector.GetComponent<MasterSelector>().P2Lilith = false;
                MasterSelector.GetComponent<MasterSelector>().Lilith = false;
            }
            if (curCharacter == 4)
            {
                MasterSelector.GetComponent<MasterSelector>().P2Azazel = false;
