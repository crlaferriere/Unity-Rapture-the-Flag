...
public class Player3Select : MonoBehaviour {
    ...
    public Text Player3Text, Player3Character;
    ...
    void Start ()
    {
        ...
        Player3Panel.GetComponent<Image>().color = new Vector4(124, 124, 124, 100);
        Player3Text.text = "Player Three";
        Player3Character.text = "Lilith";
        curCharacter = 3;
        canSwap = true;
    ...
    void Update ()
    {
        ...
        else if (curCharacter == 2)
        {
            ...
            Player3Character.text = "Barachial";
        }
    ...
    private void ProcessInput()
    {
        ...
        if (selected)
        {
            if (curCharacter == 1 && !masterReference.Urial && !masterReference.P1Urial && !masterReference.P2Urial && !masterReference.P3Urial && !masterReference.P4Urial)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P3Urial = true;
                Player3Panel.GetComponent<Image>().color = Blue;
            ...
            else if (curCharacter == 2 && !masterReference.Barachial && !masterReference.P1Barachial && !masterReference.P2Barachial && !masterReference.P3Barachial && !masterReference.P4Barachial)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P3Barachial = true;
                Player3Panel.GetComponent<Image>().color = Blue;
                Player3Text.text = "Ready!";
            }
            else if (curCharacter == 3 && !masterReference.Lilith && !masterReference.P1Lilith && !masterReference.P2Lilith && !masterReference.P3Lilith && !masterReference.P4Lilith)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P3Lilith = true;
                Player3Panel.GetComponent<Image>().color = Red;
            ...
            else if (curCharacter == 4 && !masterReference.Azazel && !masterReference.P1Azazel && !masterReference.P2Azazel && !masterReference.P3Azazel && !masterReference.P4Azazel)
            {
                ...
                MasterSelector.GetComponent<MasterSelector>().P3Azazel = true;
                Player3Panel.GetComponent<Image>().color = Red;
                AzazelVO.GetComponent<AudioSource>().Play();
                Player3Text.text = "Ready!";
            }
            else if (!MasterSelector.GetComponent<MasterSelector>().P3Urial && !MasterSelector.GetComponent<MasterSelector>().P3Barachial && !MasterSelector.GetComponent<MasterSelector>().P3Lilith && !MasterSelector.GetComponent<MasterSelector>().P3Azazel)
            {
                selected = false;
                deselected = true;
                canSwap = true;
        ...
        if (deselected)
        {
            ...
            if (curCharacter == 1)
            {
                MasterSelector.GetComponent<MasterSelector>().P3Urial = false;
                MasterSelector.GetComponent<MasterSelector>().Urial = false;
            }
            if (curCharacter == 2)
            {
                MasterSelector.GetComponent<MasterSelector>().P3Barachial = false;
                MasterSelector.GetComponent<MasterSelector>().Barachial = false;
            }
            if (curCharacter == 3)
            {
                MasterSelector.GetComponent<MasterSelector>().P3Lilith = false;
                MasterSelector.GetComponent<MasterSelector>().Lilith = false;
            }
            if (curCharacter == 4)
            {
                MasterSelector.GetComponent<MasterSelector>().P3Azazel = false;
